...
const TeacherSidebar = () => (
  <aside className="w-64 bg-slate-800 text-white p-4 flex flex-col">
    ...
    <nav className="space-y-2">
      <Link href="/teacher/teacher-dashboard" className="block p-2 rounded hover:bg-slate-700 transition">
        Dashboard
      </Link>
      <Link href="/teacher/courses" className="block p-2 rounded hover:bg-slate-700 transition">
        My Courses
      </Link>
    </nav>
  </aside>
